...
import org.jeecg.common.util.rsa.KeyManager;
import org.jeecg.common.util.rsa.MD5Util;
...
public class LoginController {
	...
	private static final String BASE_CHECK_CODES = "QWERTYUPLKJHGFDSAZXCVBNM1234567890";
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel) throws Exception {
		...
		// 解密后的明文     修改后的密码校验
		String password = MD5Util.getPwd(encryptionPassword);
		//校验密码是否一致
		boolean checkPwd = MD5Util.getSaltverifyMD5(password, sysUser.getPassword());
		if(!checkPwd){
